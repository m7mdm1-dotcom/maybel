...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    "contact.form.title": "Book your discovery call",
    "contact.form.desc": "Fill in your details below and you'll be redirected to pick a time that works for you.",
    "contact.form.firstName": "First Name",
    "contact.form.lastName": "Last Name",
    "contact.form.company": "Company Name",
    "contact.form.email": "Work Email",
    "contact.form.submit": "Continue to Schedule",
    ...
    "contact.calendar.title": "Pick a time",
    "contact.calendar.back": "Back",
  ...
  ar: {
    ...
    "contact.form.title": "احجز مكالمة استكشافية",
    "contact.form.desc": "أدخل بياناتك أدناه وسيتم توجيهك لاختيار موعد مناسب لك.",
    "contact.form.firstName": "الاسم الأول",
    "contact.form.lastName": "اسم العائلة",
    "contact.form.company": "اسم الشركة",
    "contact.form.email": "البريد الإلكتروني",
    "contact.form.submit": "متابعة للجدولة",
    "contact.form.submitting": "جارٍ الإرسال...",
    "contact.form.legal": "بإرسال هذا النموذج، فإنك توافق على سياسة الخصوصية وشروط الخدمة.",
    "contact.calendar.title": "اختر موعداً",
    "contact.calendar.back": "رجوع",
